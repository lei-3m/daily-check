...
function DrawerDocumentRow({
  ...
  return (
    <li className="grid grid-cols-[minmax(0,1fr)_auto_auto_auto] items-center gap-2 py-2 px-2.5 rounded-lg border border-transparent hover:bg-slate-50 hover:border-slate-100">
      {isEditing ? (
        <input
          ref={inputRef}
          type="text"
        ...
        <button
          ...
          className="min-w-0 text-left rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300"
        >
